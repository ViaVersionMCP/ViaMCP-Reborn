...
public class GuiCredits extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawString(this.fontRendererObj, TextFormatting.GRAY + "(https://github.com/ViaVersion/ViaVersion)", (this.width + this.fontRendererObj.getStringWidth("ViaVersion ")), (fixedHeight + this.fontRendererObj.FONT_HEIGHT) * 2 + this.fontRendererObj.FONT_HEIGHT / 2, -1);
        drawString(this.fontRendererObj, TextFormatting.GRAY + "(https://github.com/ViaVersion/ViaBackward)", (this.width + this.fontRendererObj.getStringWidth("ViaBackwards ")), (fixedHeight + this.fontRendererObj.FONT_HEIGHT * 2) * 2 + this.fontRendererObj.FONT_HEIGHT / 2, -1);
        drawString(this.fontRendererObj, TextFormatting.GRAY + "(https://github.com/ViaVersion/ViaRewind)", (this.width + this.fontRendererObj.getStringWidth("ViaRewind ")), (fixedHeight + this.fontRendererObj.FONT_HEIGHT * 3) * 2 + this.fontRendererObj.FONT_HEIGHT / 2, -1);
        drawString(this.fontRendererObj, TextFormatting.GRAY + "(https://github.com/FlorianMichael/ViaForge)", (this.width + this.fontRendererObj.getStringWidth("ViaForge ")), (fixedHeight + this.fontRendererObj.FONT_HEIGHT * 6) * 2 + this.fontRendererObj.FONT_HEIGHT / 2, -1);
        drawString(this.fontRendererObj, TextFormatting.GRAY + "(https://github.com/LaVache-FR/ViaMCP)", (this.width + this.fontRendererObj.getStringWidth("Original ViaMCP ")), (fixedHeight + this.fontRendererObj.FONT_HEIGHT * 9) * 2 + this.fontRendererObj.FONT_HEIGHT / 2, -1);
        drawString(this.fontRendererObj, TextFormatting.GRAY + "(https://github.com/Foreheadchann/ViaMCP-Reborn)", (this.width + this.fontRendererObj.getStringWidth("ViaMCP Reborn ")), (fixedHeight + this.fontRendererObj.FONT_HEIGHT * 12) * 2 + this.fontRendererObj.FONT_HEIGHT / 2, -1);
        GlStateManager.popMatrix();
