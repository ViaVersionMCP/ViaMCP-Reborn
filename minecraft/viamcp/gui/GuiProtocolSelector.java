...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_)
    {
        ...
        drawString(this.fontRendererObj, "Credits", 3, this.height * 2 - 30, -1);
        drawString(this.fontRendererObj, "ViaForge: https://github.com/FlorianMichael/ViaForge", 3, this.height * 2 - 20, -1);
        drawString(this.fontRendererObj, "Original ViaMCP: https://github.com/LaVache-FR/ViaMCP", 3, this.height * 2 - 10, -1);
        GL11.glPopMatrix();
